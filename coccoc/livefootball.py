...
HOSTNAME =["210f964ff.vws.vegacdn.vn"]
...
def response(host):
  try:
    query = 'hostname:"' + host + '" OR hostname:"cdn2.tvfootball.net"'
    body_ = {
      "size": 0,
      "query": {
        "filtered": {
...
if __name__ == '__main__':
  ...
  with open("/opt/coccoc/output/c856306433bdab6d85a78ba9f8486388-livetvfootball-response.json", "w") as f:
    f.write(json.dumps(result_response))
  f.close()
  with open("/opt/coccoc/output/c856306433bdab6d85a78ba9f8486388-livetvfootball-referer.json", "w") as f:
    f.write(json.dumps(result_referer))
  f.close()
  with open("/opt/coccoc/output/c856306433bdab6d85a78ba9f8486388-livetvfootball-user_agent.json", "w") as f:
